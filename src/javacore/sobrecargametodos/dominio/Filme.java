...
public class Filme {
    ...
    public void init(String titulo, Double imdb, Integer ano) {
        this.titulo = titulo;
        this.imdb = imdb;
        this.ano = ano;
    }

    public void init(String titulo, Double imdb, Integer ano, List<String> escritores) {
        this.init(titulo, imdb, ano);
